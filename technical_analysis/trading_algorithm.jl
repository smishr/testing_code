...
# ╔═╡ 2276eac1-f7c9-4617-ad82-9ff2ed1c0615
#Imports
using CSV, DataFrames, TSFrames

# ╔═╡ 1e6d5290-5776-4de0-9f76-39561eb4ea8a
using StatsBase # For mean()

# ╔═╡ 30c33d40-bf3f-4a55-8a17-e7db4c5e258c
using Indicators

# ╔═╡ c47c5166-cf92-4151-9463-ac3b851b2d1e
using MarketData

# ╔═╡ ddbf0ba7-4842-4767-b67e-68c15351146e
sp500 = TSFrame(MarketData.yahoo("^GSPC"))

# ╔═╡ be0190f3-6e17-4ed4-bf57-b7cac3fd024f
date_from = Date(2021, 03, 1)

# ╔═╡ 2e908376-8e19-4d16-8aca-fd27f1129ce4
date_to = Date(2023, 03, 1)

# ╔═╡ f7575c5b-ce41-43ce-939c-f17a76a63f9d
sp500_2y = TSFrames.subset(sp500, date_from, date_to)

# ╔═╡ 05e79665-c618-46d2-b82a-65adbe50f3f0
typeof(sp500_2y.AdjClose)

# ╔═╡ 61a12ba4-1c5a-4d83-a133-1800967fbdcd
macd(sp500_2y.AdjClose)

# ╔═╡ a3e2fa59-887b-4794-8a37-9c1c731698eb
rsi(sp500_2y.AdjClose)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "4ef2019d7b9026991fbd7122f97e1a953cede175"
...
git-tree-sha1 = "658f76c3a4e544ef38db91bb5402c1db669a7fc7"
...
git-tree-sha1 = "089833671a9144bb5e7de288f04a615c39656228"
